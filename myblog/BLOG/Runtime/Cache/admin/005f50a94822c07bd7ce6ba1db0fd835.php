...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			var CONTROL1='<?php echo U(GROUP_NAME."/Login/checkusername");?>'	;
		</script>
	</head>
	<body>
		<div id="top">
		...
		<div class="login">	
			...
			<table border="1" width="100%">
				...
				<tr>
					<th>验证码:</th>
					<td>
						<input type="code" class="len250" name="verify"/> <img src="<?php echo U(GROUP_NAME.'/Login/verify');?>" id="code"/ onclick="this.src=this.src+'?'+Math.random()"> <a href="javascript:void(change_code(this));">看不清</a>
					</td>
				</tr>
				<tr>
